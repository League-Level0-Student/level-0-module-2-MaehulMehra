...
public class StringsCannotAdd {
	...
	public static void main(String[] args) {
			...
			String fourAsString = JOptionPane.showInputDialog(null, "Type the number four.");
			// 3) Ask the user to enter number 6 and hold it in the variable sixAsString 
			String sixAsString = JOptionPane.showInputDialog(null, "Type the number 6");
			...
			String fiveAsString = JOptionPane.showInputDialog (null,"Type the number five");
